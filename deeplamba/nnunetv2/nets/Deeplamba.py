...
if __name__ == '__main__':
    ...
    model = Deeplamba(in_chans=3, out_chans=13, feat_size=[48, 96, 192, 384, 768], depths=[2, 2, 9, 2],
                      drop_path_rate=0.2)
    # model = _ASPP(in_channels=96, out_channels=96, atrous_rates=(6,12,18), norm_layer=nn.BatchNorm2d, norm_kwargs=None)
