...
class DeeplambaNoSkipAndRFB(nn.Module):
    def __init__(
            self,
            in_chans=1,
            out_chans=13,
        ...
        self.conv1 = nn.Conv2d(in_channels=96, out_channels=self.out_chans, kernel_size=1,
                               stride=1)
        ...
        self.finalpatchexpand = FinalPatchExpand_X4(input_resolution=None, dim=96)
...
def get_DeeplambaNoSkipAndRFB_from_plans(
...
if __name__ == '__main__':
    ...
    model = DeeplambaNoSkipAndRFB(in_chans=3, out_chans=13, feat_size=[48, 96, 192, 384, 768], depths=[2, 2, 9, 2],
                      drop_path_rate=0.2)
