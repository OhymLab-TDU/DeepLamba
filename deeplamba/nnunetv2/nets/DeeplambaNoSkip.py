...
class DeeplambaNoSkip(nn.Module):
    def __init__(
            self,
            in_chans=1,
            out_chans=13,
...
def get_DeeplambaNoSkip_from_plans(
...
if __name__ == '__main__':
    ...
    model = DeeplambaNoSkip(in_chans=3, out_chans=13, feat_size=[48, 96, 192, 384, 768], depths=[2, 2, 9, 2],
                      drop_path_rate=0.2)
