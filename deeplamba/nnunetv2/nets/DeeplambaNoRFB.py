...
class DeeplambaNoRFB(nn.Module):
    def __init__(
            self,
            in_chans=1,
            out_chans=13,
    ...
    def forward(self, x):
        ...
        enc_total = torch.cat([enc2, enc3, enc4, enc5], dim=1)
...
def get_DeeplambaNoRFB_from_plans(
...
if __name__ == '__main__':
    ...
    model = DeeplambaNoRFB(in_chans=3, out_chans=13, feat_size=[48, 96, 192, 384, 768], depths=[2, 2, 9, 2],
                      drop_path_rate=0.2)
