...
from nnunetv2.nets.DeeplambaNoSkipAndRFB import get_DeeplambaNoSkipAndRFB_from_plans
from nnunetv2.training.nnUNetTrainer.variants.network_architecture.nnUNetTrainerNoDeepSupervision import \
    nnUNetTrainerNoDeepSupervision


class nnUNetTrainerDeepLambaNoSkipAndRFB(nnUNetTrainerNoDeepSupervision):
    ...
    def build_network_architecture(
        ...
        model = get_DeeplambaNoSkipAndRFB_from_plans(
            plans_manager,
            dataset_json,
