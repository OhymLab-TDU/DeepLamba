...
from nnunetv2.nets.DeeplambaNoSe import get_DeeplambaNoSe_from_plans
from nnunetv2.training.nnUNetTrainer.variants.network_architecture.nnUNetTrainerNoDeepSupervision import \
    nnUNetTrainerNoDeepSupervision


class nnUNetTrainerDeepLambaNoSe(nnUNetTrainerNoDeepSupervision):
    ...
    def build_network_architecture(
        ...
        model = get_DeeplambaNoSe_from_plans(
            plans_manager,
            dataset_json,
