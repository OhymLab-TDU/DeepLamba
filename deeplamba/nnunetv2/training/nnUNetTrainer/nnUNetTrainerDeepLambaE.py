...
from nnunetv2.nets.DeeplambaE import get_DeeplambaE_from_plans
from nnunetv2.training.nnUNetTrainer.variants.network_architecture.nnUNetTrainerNoDeepSupervision import \
    nnUNetTrainerNoDeepSupervision


class nnUNetTrainerDeepLambaE(nnUNetTrainerNoDeepSupervision):
    ...
    def build_network_architecture(
        ...
        model = get_DeeplambaE_from_plans(
            plans_manager,
            dataset_json,
