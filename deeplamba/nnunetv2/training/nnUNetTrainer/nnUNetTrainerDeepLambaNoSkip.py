...
from nnunetv2.nets.DeeplambaNoSkip import get_DeeplambaNoSkip_from_plans
from nnunetv2.training.nnUNetTrainer.variants.network_architecture.nnUNetTrainerNoDeepSupervision import \
    nnUNetTrainerNoDeepSupervision


class nnUNetTrainerDeepLambaNoSkip(nnUNetTrainerNoDeepSupervision):
    ...
    def build_network_architecture(
        ...
        model = get_DeeplambaNoSkip_from_plans(
            plans_manager,
            dataset_json,
