...
from nnunetv2.nets.AsSwinUMambav2 import get_Asswin_umamba_from_plans


class nnUNetTrainerAsSwinUMambav2(nnUNetTrainer):
    """ Swin-UMamba """
    ...
    def build_network_architecture(
        ...
        model = get_Asswin_umamba_from_plans(
            plans_manager,
            dataset_json,
