...
from nnunetv2.nets.DeeplambaNoRFB import get_DeeplambaNoRFB_from_plans
from nnunetv2.training.nnUNetTrainer.variants.network_architecture.nnUNetTrainerNoDeepSupervision import \
    nnUNetTrainerNoDeepSupervision


class nnUNetTrainerDeepLambaNoRFB(nnUNetTrainerNoDeepSupervision):
    ...
    def build_network_architecture(
        ...
        model = get_DeeplambaNoRFB_from_plans(
            plans_manager,
            dataset_json,
