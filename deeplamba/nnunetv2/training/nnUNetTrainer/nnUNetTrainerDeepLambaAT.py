...
from nnunetv2.nets.DeeplambaAT import get_DeeplambaAT_from_plans
from nnunetv2.training.nnUNetTrainer.variants.network_architecture.nnUNetTrainerNoDeepSupervision import \
    nnUNetTrainerNoDeepSupervision


class nnUNetTrainerDeepLambaAT(nnUNetTrainerNoDeepSupervision):
    ...
    def build_network_architecture(
        ...
        model = get_DeeplambaAT_from_plans(
            plans_manager,
            dataset_json,
